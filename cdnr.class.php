...
class CDN_Rewrites
{
	...
	*/
	function build_options_form()
	{
		...
		<div id="editDiv">
		    <p id="editInstruction">Choose one of the profile to edit it.</p>
...
";
    ...
    */
    ...
    function show_powered()
    {
        ...
        if ($options['powered'])
        {
            echo '<p class="cdnr_powered" style="text-align: center;"><small>Powered by <a href="http://www.phoenixheart.net/wp-plugins/cdn-rewrites/">CDN Rewrites</a></small></p>';
        }
    }
}
